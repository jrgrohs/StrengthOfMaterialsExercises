...
![Figure 1: Two sylinders are stacked on top of each other.](images/419.png){fig-alt="A simply supported beam of length 2L is subjected to a distributed load w, a force F, and moment M. The distributed load occurs over length L, the force occurs at L, and the moment occurs at 2L."}
