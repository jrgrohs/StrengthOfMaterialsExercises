...
![Figure 1: Two sylinders are stacked on top of each other.](images/420.png){fig-alt="A simply supported beam of length 2L is subjected to two distributed loads, w1 and w2. The distributed load w1 occurs over length L and the second distributed load w2 occurs from L to 2L."}
