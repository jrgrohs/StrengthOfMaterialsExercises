# Problem 11.26 {.unnumbered}


![Figure 1: Two sylinders are stacked on top of each other.](images/422.png){fig-alt="An overhanging beam of length L1+L2 is subjected to a distributed load w. The distributed load is applied over length L2."}
