# Problem 11.37 {.unnumbered}


![Figure 1: Two sylinders are stacked on top of each other.](images/437.png){fig-alt="A simply supported beam of length 2L is subjected to two distributed loads w1 and w2. The distributed load w1 occurs over L and the distributed load w2 occurs over L."}
