...
![Figure 1: Two sylinders are stacked on top of each other.](images/440.png){fig-alt="A beam of length 2L is subjected to a force F. The beam is mounted on the left end to a wall, and the force F is applied a distance of L away. The right end of the beam is pinned."}
