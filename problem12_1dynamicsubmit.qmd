# Problem 12.1 {.unnumbered}


![Figure 1: Two sylinders are stacked on top of each other.](images/489.png){fig-alt="A member is induced to a state of stress with components sigma_y, tau_xy_ and sigma_x. The ember has a plane a-a at an angle theta."}
