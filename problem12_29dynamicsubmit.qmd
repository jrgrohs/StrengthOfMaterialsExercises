# Problem 12.29 {.unnumbered}

![Figure 1: A beam is subjected to a distributed load and force applied. ](images/529.png){fig-alt="A member is subjected to a state of stress caused by sigma_x, sigma_y, and tau_xy."}
