# Problem 12.2 {.unnumbered}


![Figure 1: Two sylinders are stacked on top of each other.](images/499.png){fig-alt="A member under a state of stress is rotated at an angle of theta along the plane a-a. The member undergoes stresses sigma_y, sigma_x, and tau_xy."}
