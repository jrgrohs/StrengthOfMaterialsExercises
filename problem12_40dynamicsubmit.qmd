...
![Figure 1: A beam is subjected to a distributed load and force applied. ](images/687.png){fig-alt="There is no figure for this problem."}
...
def server(input, output, session):
    ...
    def ui_problem_statement():
        return [ui.markdown(f"A plane stress state results in principal stress σ<sub>1</sub> = {sigma1()} ksi and τ<sub>max</sub>-in-plane = {tau_max()} ksi. Use Mohr's Circle to determine σ<sub>2</sub> and the maximum absolute shear stresses.")]
