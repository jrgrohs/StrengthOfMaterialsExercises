...
![Figure 1: Two sylinders are stacked on top of each other.](images/563.png){fig-alt="A spherical pressure vessel has a internal diameter of di and a thickness of t."}
...
def server(input, output, session):
    ...
    def ui_problem_statement():
        return[ui.markdown(f"A spherical thin-walled pressure vessel is to be constructed of steel with a yield stress of {sigma_yield()} ksi and a wall thickness t = {t()} in. If the interal diameter of the tank is d<sub>i</sub> = {di()} ft, determine the maximum allowable pressure before yielding.")]
