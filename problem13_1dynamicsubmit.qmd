...
![Figure 1: Two sylinders are stacked on top of each other.](images/556.png){fig-alt="A cylindrical pressure vessel has a thickness of t and an outer diameter of d. There is an internal pressure P and an external torque of T at the top."}
...
def server(input, output, session):
    ...
    def _():
        ...
        sigma_a = P()*(d()/2-t())/(2*t())
        sigma_h = P()*(d()/2-t())/t()
        instr= ((sigma_a+sigma_h)/2+math.sqrt(((sigma_h-sigma_a)/2)**2+tau_ha**2))/10**3
