...
![Figure 1: Two sylinders are stacked on top of each other.](images/558.png){fig-alt="A pressure vessel with a diameter of d has an internal pressure P and a thickness of t."}
...
def server(input, output, session):
    ...
    def ui_problem_statement():
        return[ui.markdown(f"A cylindrical pressure vessel of outer diameter d = {d()} mm experiences an internal pressure P = {P()} kPa. Determine the maximum shear stress in the vessel wall if the wall thibckness is t = {t()} mm.")]
