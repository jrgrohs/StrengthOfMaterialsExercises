...
![Figure 1: Two sylinders are stacked on top of each other.](images/522.png){fig-alt="A cantilevered solid circular rod is subjected to a point load F and a torsional force of F. The rod has a radius of r and a length of L.."}
