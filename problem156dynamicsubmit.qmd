...
def server(input, output, session):
    ...
    def ui_problem_statement():
        return[ui.markdown(f"A 2 inch thick board is cut and then glued back together along a line that is {Θ()} = ° off the vertical as shown. If height {h()} = in. and {F()} =  lb, determine the normal stress along the cut line.")]
    ...
    def randomize_vars():
        ...
        h.set(random.randrange(5, 15, 0.1))
