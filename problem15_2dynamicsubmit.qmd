...
![Figure 1: Two sylinders are stacked on top of each other.](images/610.png){fig-alt="A C 12x30 channel beam has a length of L and is subjected to a force Pcr."}
...
def server(input, output, session):
    ...
    def ui_problem_statement():
        return[ui.markdown(f"A C 12 x 30 channel beam is used as a column that is pinned at both ends. If length L = {L()} ft and the elastic modulus E = {E()} x 10<sup>6</sup> psi, determine the critical stress for the column.")]
