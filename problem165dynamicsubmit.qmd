...
def server(input, output, session):
    ...
    def ui_problem_statement():
        return[ui.markdown(f"A bracket is attached to a wall with two circular rivets of diameter {d()} =  mm. A load {F()} = kN is applied in the center of the bracket. Assuming the load is split evenly between the two rivits, determine the shear stress in each rivet. ")]
