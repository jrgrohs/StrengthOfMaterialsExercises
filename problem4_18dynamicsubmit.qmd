...
![Figure 1: There is no figure for this problem.](images/658.png){fig-alt="No figure for this problem."}
...
def server(input, output, session):
    ...
    def ui_problem_statement():
        return[ui.markdown(f"A copper pipe (α = 17x10<sup>-6</sup> 1/°C) of length L = {L()} m is cooled from {Ti()}°C to to {Tf()}°C. Determine the longitudinal strain in the cooled pipe.")]
