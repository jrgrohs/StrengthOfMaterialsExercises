...
![Figure 1: There is no figure for this problem.](images/659.png){fig-alt="There is no figure for this problem."}
...
def server(input, output, session):
    ...
    def ui_problem_statement():
        return[ui.markdown(f"Upon plant startup, a steel steam pipe (α = 6.5 x 10^-6 /°F) of length L = {L()} ft is raised in temperature from an ambiant temperature of {Ti()}°F to {Tf()}°F. Determine the change in length of the pipe.")]
