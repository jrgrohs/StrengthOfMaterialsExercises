...
![Figure 1: A distributed load is applied to a beam. ](images/318.png){fig-alt=" A distributed load, w, is applied to a beam. The beam is length 2L and the load is applied on length L. "}
...
app_ui = ui.page_fluid(
    ...
    ui.input_text("answer2", "Your Answer 2 in units of kip-lb", placeholder="Please enter your answer 2"),
...
def server(input, output, session):
    ...
    def randomize_vars():
        ...
        L.set(random.randrange(40, 10, 1)/10)
    ...
    def _():
        ...
        if correct1 and correct2:
            ...
            check = "*One or both answers are Not Correct.*"
